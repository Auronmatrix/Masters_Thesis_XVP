namespace XVP.Presentation.MVC.Controllers
{
    ...
    using XVP.Presentation.MVC.Models;

    [Authorize]
    public class AccountController : BaseMultiTenantController
    {
       ...
       public ApplicationSignInManager SignInManager
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var result =
                await
                this.SignInManager.PasswordSignInAsync(model.Email, model.Password, model.RememberMe, shouldLockout: false);
            switch (result)
            {
